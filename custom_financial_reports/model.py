...
class CustomFinancialReport(models.AbstractModel):
    _name = 'report.custom_financial_reports.module_report'

    @api.model
    def render_html(self,docids, data=None):

        report_obj = self.env['report']
        report = report_obj._get_report_from_name('custom_financial_reports.module_report')
                    ...
                    if a.entry_type != 'heading':
                        ...
                        if a.entry_type == 'account':
                            ...
                            for b in divisions:
                                ...
                                baranch_accounts = self.env['account.move'].search([('branch', '=', b),('date','>=',record_wizard.form),('date','<=',record_wizard.to)])
                ...
                for a in report_heads:
                    ...
                    if a.entry_type != 'heading':
                        ...
                        if a.entry_type == 'account':
                            ...
                            baranch_accounts = self.env['account.move'].search([('date','>=',record_wizard.form),('date','<=',record_wizard.to)])
        ...
        return report_obj.render('custom_financial_reports.module_report', docargs)